...
1. **Source Directory**: All skills MUST be created inside `skills/<skill-name>/` in this repo.
...
4. **Symlink Installation**: When creating or modifying a skill, create a symlink in global config:
   ```bash
